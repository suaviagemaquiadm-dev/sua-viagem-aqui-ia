...
/**
 * Recupera um valor do localStorage, retornando null se estiver expirado ou corrompido.
 * @param {string} key A chave do item a ser recuperado.
 * @returns {any | null} O valor armazenado ou null se não existir, estiver expirado ou corrompido.
 */
export function getWithTTL(key) {
  ...
  try {
    ...
    // Se o JSON estiver corrompido, remove o item para evitar erros futuros.
