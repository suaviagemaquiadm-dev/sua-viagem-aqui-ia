...
async function loadCarouselsAndGrids() {
  try {
    ...
    const { premiumPartners, basicPartners, allPartnersForInfiniteScroll } =
      result.data;
    ...
    showAlert(
      "Não foi possível carregar os destaques da página. Tente recarregar.",
    );
  }
  ...
  const testimonialsData = [
    {
      name: "Maria S.",
      role: "Pousada Aconchego",
      quote:
        "Desde que entramos na plataforma, nossa taxa de ocupação aumentou em 30%. O acesso direto aos viajantes fez toda a diferença!",
      img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=250",
    },
    {
      name: "João P.",
      role: "Guia de Ecoturismo",
      quote:
        "A visibilidade que o plano Basic me deu foi incrível. Recebo contatos de clientes que antes eu nem sonhava em alcançar. Recomendo!",
      img: "https://images.unsplash.com/photo-1568602471122-7832951cc4c5?q=80&w=250",
    },
  ];
...
async function fetchWeather() {
  ...
  try {
    ...
    if (!dailyForecasts.length)
      throw new Error("Previsão diária não encontrada.");
